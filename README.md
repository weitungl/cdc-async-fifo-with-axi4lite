...
* **Scoreboard Data Integrity (`fifo_scoreboard.sv`)**: Independent write/read monitors capture transactions on the fly and feed them to an in-order reference queue, verifying **zero data mismatches and zero transaction drops** across all 4 operational modes. 
